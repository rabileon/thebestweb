  ...
  const fetchFiles = async (page) => {
    ...
    try {
      const response = await fetch(
        `https://api-drive-demo-production.up.railway.app/api/files?page=${page}&limit=100&type=audio`
      );
              ...
              (
                <div className='mt-4 w-full'>
                  <audio controls autoPlay>
                    <source
                      src={`https://api-drive-demo-production.up.railway.app/api/cloud/preview/${file.idFile}`}
                      type='audio/mp3'
                    />
